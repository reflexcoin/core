...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(RFLX);
    unitlist.append(mRFLX);
    unitlist.append(uRFLX);
...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case RFLX: return QString("RFLX");
            case mRFLX: return QString("mRFLX");
            case uRFLX: return QString::fromUtf8("μRFLX");
    ...
    else
    {
        switch(unit)
        {
            case RFLX: return QString("tRFLX");
            case mRFLX: return QString("mtRFLX");
            case uRFLX: return QString::fromUtf8("μtRFLX");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case RFLX:  return 100000000;
    case mRFLX: return 100000;
    case uRFLX: return 100;
    case duffs: return 1;
