    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  reflex-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Reflex in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RFLX, 0.1 RFLX, 1 RFLX and 10 RFLX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://reflexpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://reflexpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
