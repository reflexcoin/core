    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RFLX-light"), QVariant("light"));
    ui->theme->addItem(QString("RFLX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("RFLX-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("RFLX-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("RFLX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RFLX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RFLX-traditional"), QVariant("trad"));
