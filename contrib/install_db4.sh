...
echo 'When compiling reflexd, run `./configure` in the following way:'
echo
echo "  export BDB_PREFIX='${BDB_PREFIX}'"
# shellcheck disable=SC2016
echo '  ./configureCPPFLAGS="$CPPFLAGS -I${BDB_PREFIX}/include" LIBS="$LIBS -L${BDB_PREFIX}/lib -ldb_cxx-4.8" ...'
